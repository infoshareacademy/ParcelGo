...
class ParcelLockerSearchTestCase(TestCase):
    def setUp(self):
        ParcelLocker.objects.get_or_create(
            locker_number="1A",
            city="Warszawa",
            street="Testowa",
            street_number="1",
    ...
    def test_no_results(self):
        ...
        self.assertEqual(
            request.context["no_results_message"],
            "No results found for your query: 'AAA'",
        )
...
class ParcelCreationTestCase(TestCase):
    def setUp(self):
        ...
        self.parcel_locker = ParcelLocker.objects.create(
            locker_number="A1",
            city="Warszawa",
            street="Testowa",
            street_number="1",
    ...
    def test_create_parcel_view_invalid_form(self):
        ...
        )  # Check if form re-rendered with errors
